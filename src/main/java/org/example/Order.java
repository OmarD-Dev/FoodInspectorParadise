...
public class Order {
    ...
    boolean drink; // we can make it a lot more detailed later but for now drink is either yes or no
    boolean chips;// we can make it a lot more detailed later but for now chips are either yes or no
